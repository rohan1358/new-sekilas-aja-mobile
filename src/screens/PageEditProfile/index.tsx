import { AboutHeader, Base, Button, DummyFlatList, TextField, TextItem } from '../../components';
import React, { useEffect, useMemo, useRef, useState } from 'react'
import { ActivityIndicator, Keyboard, StyleSheet, Text, TextInput, View } from 'react-native';
import styles from './styles';
import { neutralColor, strings, snackState as ss, pages, defaultValue as dv, successColor, primaryColor } from '../../constants';
    ...
    const handlePassword = () => {
        if (passwordLama != '') {
            if (passwordBaru === passwordKonfir) {
                setIsLoading(true)
                reauthenticate(passwordLama).then(() => {
                    user?.updatePassword(passwordBaru).then(() => {
                        // success
            ...
            <DummyFlatList>
                <View style={styles.content}>
                    ...
                    <View style={styles.boxBtnAction}>
                        <Button disabled={isLoading} onPress={() => handleSimpan()} style={styles.btnAction}>
                            {
                                isLoading ?
                        ...
                        <Button disabled={isLoading} onPress={()=> navigation.goBack()} style={[styles.btnAction, styles.btnBatal]}>
