                    ...
                    <View style={styles.boxCircle}>
                        {
                            dataPage.map((_, index) => {
                                return (
                                    <View key={index} style={currentIndex == index ? styles.circleActive : styles.circle} />
                                )
                            })
                        }
                    </View>
                    <View style={styles.boxBtn}>
                        {
                            currentIndex == 0 ?
                                <Button onPress={()=> handleNext()} style={styles.button}>
                                    <TextItem type='b.20' style={styles.textBtn}>{strings.button_onBoard_1}</TextItem>
                                </Button>
                                :
                                <View style={styles.boxBtnAction}>
                                    <Button onPress={()=> navToSignIn()} style={styles.buttonLewati}>
                                        <TextItem type='b.20' style={styles.textBtnLewati}>{strings.btnLewati}</TextItem>
                                    </Button>
