...
import { neutralColor, primaryColor, skeleton, snackState as ss, strings } from '@constants'
            ...
            >
                <DummyFlatList>
                    ...
                    <View style={styles.sectionContent}>
                        <TextItem type="b.16.nc.90" style={styles.subTitle}>{strings.notif_sistem}</TextItem>
                        <View style={[styles.list, styles.listPreferens]}>
                            <View style={styles.boxText}>
                                <TextItem style={styles.titleList}>{strings.pengingat}</TextItem>
                                <TextItem style={styles.textContent}>{strings.text_pengingat}</TextItem>
                            </View>
                            <Switch
                        ...
                        <View style={[styles.list, styles.listPreferens]}>
                            <View style={styles.boxText}>
                                <TextItem style={styles.textContent}>{strings.ingatkan}</TextItem>
                            </View>
                            <Button onPress={()=> setModalVisible(!modalVisible)}>
                                <TextItem style={[styles.textContent, styles.textTime]}>{jam+':'+menit} PM</TextItem>
                            </Button>
                        </View>
                        <TextItem type="b.16.nc.90" style={styles.subTitle}>{strings.notif_promo}</TextItem>
                        <View style={[styles.list, styles.listPreferens]}>
                            <View style={styles.boxText}>
                                <TextItem style={styles.titleList}>{strings.promo_voucher}</TextItem>
                                <TextItem style={styles.textContent}>{strings.text_promo}</TextItem>
                            </View>
                            <Switch
                                trackColor={{ false: "#E3E8EF", true: "#464D6F" }}
                ...
                <View style={styles.containerModal}>
                    <View style={styles.contentModal}>
                        ...
                        <View style={[styles.boxHeadModal, styles.boxAction]}>
                            <Button onPress={()=>setModalVisible(!modalVisible)} style={[styles.btnAction, styles.btnSimpan]}>
