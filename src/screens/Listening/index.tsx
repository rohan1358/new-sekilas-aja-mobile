    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={styles.containerTitle}>
          ...
          >
              <TextItem style={[styles.text, styles.title]}>{titleTrack}</TextItem>
          </ScrollView>
          {/* </TextTicker> */}
          <LinearGradient
        ...
        <View>
          ...
          <View style={styles.boxTextTime}>
            <TextItem>{new Date(progress.position * 1000).toISOString().substr(14, 5)}</TextItem>
            <TextItem>{new Date((progress.duration - progress.position) * 1000).toISOString().substr(14, 5)}</TextItem>
          </View>
        </View>
        <View style={styles.boxAction}>
          ...
          <Button onPress={()=> togglePlayback(playbackState)} style={styles.play}>
            {
